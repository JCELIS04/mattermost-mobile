...
1. Sign up to be a beta tester
   - [Android](https://play.google.com/apps/testing/com.movivendor.mattermost)
   - [iOS](https://testflight.apple.com/join/Q7Rx7K9P) - Open this link from your iOS device
2. Install the `Mattermost Movivendor` app. New updates in the Beta app are released periodically. You will receive a notification when the new updates are available.
...
- On Android, [click this link](https://play.google.com/apps/testing/com.movivendor.mattermost) while logged in with your Google Play email address used to opt-in for the Beta program, then click **Leave the program**. 
- On iOS, access the `Mattermost Movivendor` app page in TestFlight and click **Stop Testing**.
